      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl p-8 shadow-2xl space-y-6 relative overflow-hidden">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">
            Sign in to your TiffinSplit roommate admin dashboard
          </p>
        </div>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <span className="bg-slate-900 px-3 text-[11px] text-slate-500 uppercase font-semibold">Or continue with</span>
          <div className="border-t border-slate-800 w-full" />
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          <div className="space-y-1">
            ...
            <input
              type="email"
              required
              placeholder="admin@tiffinsplit.local"
              value={email}
        ...
        <div className="pt-4 border-t border-slate-800/80 text-center text-xs text-slate-400">
          ...
          <Link href="/register" className="text-amber-400 font-bold hover:underline">
            Register Admin Account <ArrowRight className="w-3 h-3 inline" />
          </Link>
        </div>
      </div>
    </div>
